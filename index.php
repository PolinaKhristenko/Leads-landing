                ...
                <div class="container">
                    <div class="hot__body">
                        ...
                        <div class="hot__right">
                            <h1 class="title">Горячие лиды на банкротство физ.лиц</h1>
                            <ul class="hot__ul">
                                <li class="hot__li purple">быстро</li>
                                <li class="hot__li green">удобно</li>
                                <li class="hot__li blue">безопасно</li>
                            </ul>
                            <p class="hot__txt">Узнайте стоимость лидов в вашем регионе и получите <span class="green" style="font-weight: 600">скидку 15% на заказ</span></p>
                            <a href="./pages/quiz.php?page=quality" class="button-purple">Узнать стоимость</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="kinds" class="kinds">
                <div class="container">
                    <div class="kinds__body">
                        ...
                        <h3 class="subtitle">Предоставляем только <span class="green">реальные заявки на банкротство</span></h3>
                        <div class="kinds__down">
                            <div class="kinds__card1">
                                ...
                                <a href="../pages/quiz.php?page=sale" class="button-white">Узнать стоимость
                            ...
                            <div class="kinds__form">
                                <h5 class="subtitle">Заполните заявку и получите 5 пробных лидов</h5>
                                <form class="form1" method="post" action="../pages/form.php?page=request-try">
                                    ...
                                    <a href="../pages/form.php?page=request-try" class="button-purple" style="margin-top: 1.25rem;">Заполнить заявку</a>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <section class="how">
                <div class="container">
                    <div class="how__body">
                        ...
                        <div class="how__info">
                            <div class="how__info-img"><img src="./src/how-leads.svg" alt="От 3 дней минимальный срок поставки лидов сразу после оформления заказа"/></div>
                            <div class="how__list">
                                <div class="how__item"><img src="./src/page-green.svg" alt="Страница" />
                                    <div class="how__txt">
                                        <p class="how__subtitle">Создаем посадочные страницы</p>
                                        <p class="main__txt">Для каждого клиента мы создаем индидуальные страницы с учетом анализа аудитории</p>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="conditions__body">
                        ...
                        <div class="conditions__pics">
                            ...
                            <img class="conditions__pic" src="./src/conditions4.svg" alt="Не ваш регион" />
                        </div>
                        <p class="conditions__txt"><span class="purple">«В одни руки»</span> — мы не перепродаем лиды, вы получаете только свои лиды от нашего проекта</p>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="more__body">
                        <div class="more__left">
                            ...
                            <p class="main__txt-20 center-768">На основе нашего многолетнего опыта мы разработали скрипты продаж для операторов. Мы гарантируем доведение до результата и эффективную отработку возражений</p>
                        </div>
